#!/usr/bin/env python3
"""
GDB Script to Capture Vector Tables and System State
Use this when stopped at the same breakpoint in both scenarios
"""
...
def save_gdb_script():
    ...
    with open('capture_vectors.gdb', 'w') as f:
        f.write(gdb_commands)
    print("GDB script saved to: capture_vectors.gdb")
    print("\nTo use:")
    print("1. In GDB, when stopped at your breakpoint:")
    print("   (gdb) source capture_vectors.gdb")
    print("2. Or copy-paste the commands manually")

def print_manual_commands():
    """Print commands for manual execution"""
    print("="*80)
    print("MANUAL GDB COMMANDS TO CAPTURE VECTOR TABLES")
    print("="*80)
    print("Execute these commands in GDB when stopped at systemControl.c:518")
    print("="*80)
    print(gdb_commands)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--manual":
        ...
        save_gdb_script()
        print("\nFor manual commands, run: python capture_vectors_gdb.py --manual")
