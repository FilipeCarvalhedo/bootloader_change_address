#!/usr/bin/env python3
"""
GDB Script to Investigate Stack Corruption
Execute when stopped at systemControl.c:518 in both scenarios
"""
...
def save_gdb_script():
    ...
    with open('investigate_stack.gdb', 'w') as f:
        f.write(gdb_commands)
    print("GDB script saved to: investigate_stack.gdb")
    print("\nTo use:")
    print("1. In GDB, when stopped at systemControl.c:518:")
    print("   (gdb) source investigate_stack.gdb")
    print("2. Compare output between Direct Flash and Bootloader scenarios")
